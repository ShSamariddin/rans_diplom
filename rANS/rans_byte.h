//
// Created by Samariddin Sharipov on 30.03.2022.
//

#ifndef RANS_DIPLOM_RANS_BYTE_H
#define RANS_DIPLOM_RANS_BYTE_H
...
void xor_pgms(uint8_t* fr, uint8_t* se){
